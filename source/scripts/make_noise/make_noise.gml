...
// Due to how the algorithm works some values may be above/below the given max, so we need to figure out how much to scale by to correct it
#region VALUE RANGE CORRECTION (Also calculates the average value)
	var maxValue = valMax;
	var minValue = valMin;
	var valTotal = 0;
